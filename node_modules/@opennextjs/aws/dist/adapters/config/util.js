...
export function loadPagesManifest(nextDir) {
...
export function loadAppPathsManifest(nextDir) {
    ...
    const appPathsManifestJson = fs.existsSync(appPathsManifestPath)
        ...
        : "{}";
    return JSON.parse(appPathsManifestJson);
}
export function loadAppPathRoutesManifest(nextDir) {
...
export function loadFunctionsConfigManifest(nextDir) {
