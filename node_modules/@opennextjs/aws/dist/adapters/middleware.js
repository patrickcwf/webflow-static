...
import { resolveAssetResolver, resolveIncrementalCache, resolveOriginResolver, resolveProxyRequest, resolveQueue, resolveTagCache, } from "../core/resolve";
import { constructNextUrl } from "../core/routing/util";
import routingHandler, { INTERNAL_EVENT_REQUEST_ID, INTERNAL_HEADER_INITIAL_URL, INTERNAL_HEADER_RESOLVED_ROUTES, } from "../core/routingHandler";
...
const defaultHandler = async (internalEvent, options) => {
    ...
    globalThis.incrementalCache = await resolveIncrementalCache(config?.override?.incrementalCache);
    //#endOverride
