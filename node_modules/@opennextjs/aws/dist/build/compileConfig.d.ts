 ...
 */
export declare function compileOpenNextConfig(baseDir: string, openNextConfigPath?: string, { nodeExternals, compileEdge }?: {
...
export declare function compileOpenNextConfigNode(sourcePath: string, outputDir: string, externals: string[]): string;
export declare function compileOpenNextConfigEdge(sourcePath: string, outputDir: string, externals: string[]): void;
