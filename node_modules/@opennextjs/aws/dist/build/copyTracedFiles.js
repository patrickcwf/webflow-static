...
import { copyFileSync, cpSync, existsSync, mkdirSync, readFileSync, readdirSync, readlinkSync, statSync, symlinkSync, writeFileSync, } from "node:fs";
...
--------------------------------------------------------------------------------`);
    ...
    if (hasPageDir) {
        ...
        const staticFiles = Object.values(pagesManifest);
